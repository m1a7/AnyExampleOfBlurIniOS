...
@interface BlurViewController3 ()

@end

@implementation BlurViewController3
...
- (void)viewDidLoad {
    ...
    /*
      Static blur
    */
    UIImageView *blur = [[UIImageView alloc] initWithFrame:CGRectMake( CGRectGetMinX(imageView.frame)+offset,
                                                                       CGRectGetMinY(imageView.frame)+offset, 200, 200)];
    blur.image = [self blur:imageView.image];
